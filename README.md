...
block-beta
    ...
    space A["CLAUDE.md<br>哲学: WHO / WHY / WHAT / HOW / MAP"]:3 space
    space:1 B["OUTLINE.md<br>構造: ゴール・種類・依存関係"]:3 space:0
    C["writing.md<br>ルール: 文体・テンプレート・用語"]:5
    D["curriculums/<br>教材本体"]:5
