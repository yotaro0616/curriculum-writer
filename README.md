...
```
Phase 0: TOPIC・スコープの確定
Phase 1: 哲学の定義（WHO / WHY / WHAT / HOW / MAP）
Phase 2: OUTLINE の構造化（MECE 分解）
Phase 3: writing.md のルール調整
Phase 4: 最終確認
```
...
CLAUDE.md（哲学: WHO/WHY/WHAT/HOW/MAP）
    ↓ MECE 分解
OUTLINE.md（構造: 各 Section のゴール・種類・依存関係）
    ↓ 執筆ルールに沿って執筆
curriculums/（教材本体）
```
